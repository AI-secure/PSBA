...
if __name__ == '__main__':
    ...
    # compare()
    pgens = ['facepp_naive','facepps45_evolution','facepp_sign_opt','facepp_resize9408', 'facepp_DCT9408','facepp_PCA9408',  'facepp_AE9408', 'facepp_VAE9408', 'facepps4_PGAN9408']
    names = ['HSJA', 'EA','Sign-OPT','QEBA-S', 'QEBA-F', 'QEBA-I', 'NLBA-AE' , 'NLBA-VAE', 'PSBA-PGAN']
    styles = ['--',  '-.', '-.','-.', '-.', '-.', '-', '-', '-']
    rgb_colors = ['k', '#FF0000', '#FF8000', '#00994C', '#0066CC', '#8c564b', '#e377c2', '#bcbd22','#934BD1','#B01260','#F26749','#497E8C','#6100b4']
    # for pgen in pgens:
