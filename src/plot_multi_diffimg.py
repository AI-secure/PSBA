...
def plot_fig(TASK, rgb_colors):
    if TASK == 'imagenet':
        PLOT_INFO = [
            ...
            ('BAPP_result/attack_multi_imagenet_AE9408_.log', rgb_colors[3], 'NLAB-AE'),
            ('BAPP_result/attack_multi_imagenet_VAE9408_.log', rgb_colors[4], 'NLBA-VAE'),
            ('BAPP_result/attack_multi_imagenet_PGAN9408_res18u1.log'% (TASK), rgb_colors[5], 'PGAN7' ),
            ('BAPP_result/attack_multi_imagenet_PGAN9408_res18u2.log'% (TASK), rgb_colors[6], 'PGAN14'),
            ('BAPP_result/attack_multi_imagenet_PGAN9408_res18u3.log'% (TASK), rgb_colors[7], 'PGAN28' ),
            ('BAPP_result/attack_multi_imagenet_PGAN9408_res18u4.log'% (TASK), rgb_colors[8], 'PGAN56' ),
            ('BAPP_result/attack_multi_imagenet_PGAN9408_res18u5.log'% (TASK), rgb_colors[9], 'PGAN112' ),
            ('BAPP_result/attack_multi_imagenet_PGAN9408_res18u6.log'% (TASK), rgb_colors[10], 'PGAN224' ),
        ]
        ...
        PLOT_INFO = [
            ...
            ('BAPP_result/attack_multi_celeba_AE9408_.log', rgb_colors[3], 'NLAB-AE' ),
            ('BAPP_result/attack_multi_celeba_VAE9408_.log', rgb_colors[4], 'NLAB-VAE' ),
        ]
        ...
        PLOT_INFO = [
            ...
            ('BAPP_result/attack_multi_cifar10_224_AE9408_.log', rgb_colors[3], 'NLAB-AE' ),
            ('BAPP_result/attack_multi_cifar10_224_VAE9408_.log', rgb_colors[4], 'NLAB-VAE' ),
        ]
        # for i in range(8):
        ...
        PLOT_INFO = [
            ...
            ('BAPP_result/attack_multi_%s_AE9408_.log' %(TASK), rgb_colors[3], 'NLAB-AE' ),
            ('BAPP_result/attack_multi_%s_VAE9408_.log' %(TASK), rgb_colors[4], 'NLAB-VAE'),
        ]
...
def plot_n_perline(rgb_colors):
    ...
    for i in range(n):
        ...
        if TASK == 'imagenet':
            PLOT_INFO = [
                ('BAPP_result/attack_multi_imagenet_naive_resnet18.log', 'k', 'HSJA', '--'),
#                  ('BAPP_result/attack_multi_%s_evolution_resnet18s30.log' % (TASK), rgb_colors_1[5], 'EA','-.'),
#                  ('BAPP_result/attack_multi_%s_sign_opt_resnet18.log' % (TASK), rgb_colors[6], 'Sign-OPT','-.'),
                ('BAPP_result/attack_multi_imagenet_resize9408_resnet18.log', rgb_colors[0], 'QEBA-S', '-.'),
                ('BAPP_result/attack_multi_imagenet_DCT9408_resnet18.log', rgb_colors[1], 'QEBA-F', '-.'),
                ('BAPP_result/attack_multi_imagenet_PCA9408_resnet18.log', rgb_colors[2], 'QEBA-I', '-.'),
                ('BAPP_result/attack_multi_imagenet_AE9408_resnet18.log', rgb_colors[3], 'NLAB-AE' ),
                ('BAPP_result/attack_multi_imagenet_VAE9408_resnet18.log', rgb_colors[4], 'NLAB-VAE' ),
                ('BAPP_result/attack_multi_%s_PGAN9408_resnet18s1.log'% (TASK), rgb_colors[5], 'PGAN7' ),
                ('BAPP_result/attack_multi_%s_PGAN9408_resnet18s2.log'% (TASK), rgb_colors[6], 'PGAN14'),
                ('BAPP_result/attack_multi_%s_PGAN9408_resnet18s3.log'% (TASK), rgb_colors[7], 'PGAN28' ),
                ('BAPP_result/attack_multi_%s_PGAN9408_resnet18s4.log'% (TASK), rgb_colors[8], 'PGAN56' ),
                ('BAPP_result/attack_multi_%s_PGAN9408_resnet18s5.log'% (TASK), rgb_colors[9], 'PGAN112' ),
                ('BAPP_result/attack_multi_%s_PGAN9408_resnet18s6.log'% (TASK), rgb_colors[10], 'PGAN224' ),
            ]
        elif TASK == 'celeba':
            PLOT_INFO = [
                ('BAPP_result/attack_multi_imagenet_naive_resnet18.log', 'k', 'HSJA', '--'),
#                  ('BAPP_result/attack_multi_%s_evolution_resnet18s112.log' % (TASK), rgb_colors_1[5], 'EA','-.'),
#                  ('BAPP_result/attack_multi_%s_sign_opt_resnet18.log' % (TASK), rgb_colors[6], 'Sign-OPT','-.'),
                ('BAPP_result/attack_multi_imagenet_resize9408_resnet18.log', rgb_colors[0], 'QEBA-S', '-.'),
                ('BAPP_result/attack_multi_imagenet_DCT9408_resnet18.log', rgb_colors[1], 'QEBA-F', '-.'),
                ('BAPP_result/attack_multi_imagenet_PCA9408_resnet18.log', rgb_colors[2], 'QEBA-I', '-.'),
...
#                  ('BAPP_result/attack_multi_%s_sign_opt_resnet18.log' % (TASK), rgb_colors[6], 'Sign-OPT','-.'),
        ...
        for logs, info in zip(all_logs, PLOT_INFO):
            ...
            if "evolution" in info[0]:
                if len(info) > 3:
                    plt.plot(avg_X[3:], avg_y[3:], c=info[1], linestyle=info[3], label=info[2])
                else:
                    plt.plot(avg_X[3:], avg_y[3:], c=info[1], label=info[2])
            else:
                if len(info) > 3:
                    plt.plot(avg_X[:], avg_y[:], info[1], linestyle=info[3], label=info[2])
                else:
...
#     rgb_colors = map_vir(np.arange(600))
    
    rgb_colors = ['#FF0000', '#FF8000', '#00994C', '#0066CC', '#8c564b', '#e377c2', '#bcbd22','#934BD1','#B01260','#F26749','#497E8C','#6100b4']
