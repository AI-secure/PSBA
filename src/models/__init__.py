...
from .pgan_generator import PGenerator, PDiscriminator,calc_gradient_penalty
...
from .sign_opt_generator import SignOptGenerator
from .evolutionary_generator import EAGenerator